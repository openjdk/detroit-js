 ...
 */
final class OptionTemplate implements Comparable<OptionTemplate> {
    /** Resource, e.g. "jvmv8" for this option */
    ...
    /**
     * Get the resource name used to prefix this option set, e.g. "jvmv8"
     *
    ...
    public String toString() {
        ...
        if (params != null) {
            ...
            sb.append('\t');
            sb.append('\t');
            sb.append(Options.getMsg("jvmv8.options.param")).append(": ");
            sb.append(params);
            sb.append("   ");
            final Object def = this.getDefaultValue();
            if (def != null) {
                sb.append(Options.getMsg("jvmv8.options.default")).append(": ");
